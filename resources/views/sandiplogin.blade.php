			...
			<div class="row">
				<div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <input type="varchar" name="cpassword" placeholder="Confirm Password" id="cpassword" class="form-control">
                            </div>
                            <div class="form-group">
                              <div style="padding:30px; margin-top: -14px">  By creating an account, I accept TechEela’s<br>
                                ...
                                <br>
                               <center><input type="submit" name="submit" class="btn btn-info btn-md" id="btn-color" value="Create account" style="margin-left: -56px; margin-top: -25px;"></center>
                            </div>
