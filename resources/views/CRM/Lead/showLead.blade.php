            ...
            <div class="container-fluid">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="ServiceCode" name="ServiceCode" value="{{ $lead->lead_service_code }}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="Name" name="Name" value="{{ $lead->lead_name }}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="Designation" name="Designation" value="{{ $lead->lead_service_code }}" >
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="CompanyName" name="CompanyName" value="{{ $lead->lead_service_code }}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="MobileNo" name="MobileNo" value="{{ $lead->lead_service_code }}" >
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="LandlineNo" name="LandlineNo" value="{{ $lead->lead_service_code }}" >
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="utm_website_url" name="utm_website_url" value="{{ $lead->lead_name }}" >
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="utm_campaign_source" name="utm_campaign_source" value="{{ $lead->lead_name }}" >
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="utm_campaign_medium" name="utm_Campaign_Medium" value="{{ $lead->lead_name }}" >
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="utm_campaign_name" name="utm_campaign_name" value="{{ $lead->lead_name }}" >
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="utm_campaign_term" name="utm_campaign_term" value="{{ $lead->lead_name }}" >
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="utm_campaign_content" name="utm_campaign_content" value="{{ $lead->lead_name }}" >
                    </div>
                  </div>
            ...
            <div class="container-fluid">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="email" class="form-control" id="Email" name="Email" value="{{ $lead->lead_email }}" >
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="Address" name="Address"value="{{ $lead->lead_address }}" >
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="City" name="City" value="{{ $lead->lead_city }}" >
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="State" name="State" value="{{ $lead->lead_state }}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="Country" name="Country" value="{{ $lead->lead_country }}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="Pincode" name="Pincode" value="{{ $lead->lead_pincode }}" >
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="activity" name="activity" value="{{ $lead->lead_activity }}"
                      >
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="Lead_Status" name="Lead_Status" value="{{ $lead->lead_Status }}" >
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="Status_Inormation" name="Status_Inormation" value="{{ $lead->lead_Status_Inormation }}" >
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="Source" name="Source" value="{{ $lead->lead_Source }}" >
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="Source_Inormation" name="Source_Inormation" value="{{ $lead->lead_Source_Inormation }}" >
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="Created_By_Code" name="Created_By_Code" value="{{ $lead->lead_Created_By_Code }}" >
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="Amount_Currrency" name="Amount_Currrency" value="{{ $lead->lead_Amount_Currrency }}" >
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="total" name="total" value="{{ $lead->lead_total }}" />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="Location" name="Location" value="{{ $lead->lead_Location }}" >
                    </div>
                  </div>
                  {{-- ./The body of the card Row-2.2 --}}
