...
@foreach($data['post']['data']['post']  as $post)
          <article id="article{{$post['postID']}}" class="post" data-postid="{{$post['postID']}}">
            ...
            <div class="interaction">
                  ...
                  @endif
                  {{-- Team --}}
                  <span class="tooltip"><img  src="{{asset("/img/socialpost_interaction/interaction/visibility/teams.png")}}" width="18px" height="auto">{{-- Hover --}}
