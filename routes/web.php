...
Route::get('/registered-succesfully',
...
Route::group(['middleware' => ['auth', 'verified']], function () {
		...
		Route::get('add-user', 'Team\TeamController@createuser');
		// Route::post('add-user/', 'Team\TeamController@useradd');
		Route::get('/team-view/delete/{id}', 'Team\TeamController@destroy');
		// Route::resource('/user_team','UserTeam\UserTeamcontroller');
		...
		//  HelpDesk
		// route::resource('boards','Helpdesk\oardController');
